...
import {TTask, TTaskEntity, TTaskStatus} from 'core/entities/tasks'
import {usersStore} from 'core/entities/users'
import {TUser} from 'core/entities/users'
...
@observer
class OwnerIco extends React.Component<Partial<{owner: TUser, uuid: string}>> {
	render () {
...
const borderColorPerStatus: {[key in TTaskStatus]: TColor} = {
	new: 'neutral',
	afterDeadline: 'red',
	completed: 'neutral',
...
type TProps = Partial<{
	...
	changeTaskStatus: TTaskEntity['changeTaskStatus'],
}>
...
@observer
export default class TaskPreviewBox extends React.Component<TProps> {
