...
import {TTask, TTaskField} from 'core/entities/tasks'
import {TTaskEntity} from 'core/entities/tasks/store'
...
type TProps = Partial<{
	...
	projectUuid: string,
	task: TTask,
	updateField: TTaskEntity['updateField'],
	assignContributor: TTaskEntity['assignContributor'],
	deleteContributor: TTaskEntity['deleteContributor'],
...
type TState = {
	name: {
		isEditing: boolean,
		value: TTask['name'] | null,
	},
	brief: {
		isEditing: boolean,
		value: TTask['brief'] | null,
	},
}

type TStateField = TTaskField & keyof TState
...
@observer
export default class TaskDetail extends React.Component<TProps, TState> {
	state = {
		name: {
			isEditing: false,
			value: null,
	...
	briefEl: HTMLTextAreaElement | null = null
	...
	submitEditingField (field: TStateField, value?: {}) {
