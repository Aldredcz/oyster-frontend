import {TColor, TTheme} from 'core/config/themes/types'
...
export type TProps = {
	as?: string | React.ComponentClass<any> | React.SFC<any>,
...
const Box: React.SFC<TProps> = (props: TProps, {renderer, theme}: TBoxContent) => {
	const {
		as,
		style,
		getRef,
	...
	if (typeof as === 'function' && asBoxBasedComponent) {
		...
		return React.createElement(as as $TSFixMe, { // https://github.com/Microsoft/TypeScript/issues/15019
			...newProps,
		})
	}
	...
	return React.createElement((as || 'div') as $TSFixMe, { // https://github.com/Microsoft/TypeScript/issues/15019
...
export const withTheme = (Component: React.ComponentClass<any> | React.SFC<any>) => {
...
export function composeStyles (style: TStyleFunction | null, getStyles?: (theme: TTheme) => Object): TStyleFunction {
