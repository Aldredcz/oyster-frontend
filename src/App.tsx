...
function addStandardLayout (elem: React.ReactElement<any>): React.ReactElement<any> {
	return (
		<StandardLayout>
			{elem}
		</StandardLayout>
...
function addAccountWrapper (elem: React.ReactElement<any>): React.ReactElement<any> {
	const AccountWrapperAny = AccountWrapper as any
	return (
		<AccountWrapperAny>
			{elem}
		</AccountWrapperAny>
...
function addMobxProvider (elem: React.ReactElement<any>): React.ReactElement<any> {
	return (
		<MobxProvider
...
function addFelaProvider (elem: React.ReactElement<any>): React.ReactElement<any> {
	return (
...
function addThemeProvider (elem: React.ReactElement<any>): React.ReactElement<any> {
	return (
